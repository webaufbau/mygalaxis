...
file_put_contents('/home/famajynu/www/my_offertenschweiz_ch/git_webhook_payload.log', file_get_contents('php://input'), FILE_APPEND);
...
if (!empty(TOKEN) && isset($_SERVER["HTTP_X_HUB_SIGNATURE_256"])) {
