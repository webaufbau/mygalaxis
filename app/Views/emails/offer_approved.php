...
<h2><?= lang('Email.offer_approved_subject') ?></h2>

<p><?= lang('Email.offer_added_greeting', [$data['vorname'] ?? '', $data['nachname'] ?? '']) ?></p>

<div class="highlight">
    <p><?= lang('Email.offer_approved_thank_you', ['service' => esc($formular_page ?? lang('Offers.type.' . ($formName ?? 'other')))]) ?></p>
    <p><?= lang('Email.offer_approved_info_1') ?></p>
    <p><?= lang('Email.offer_approved_info_2') ?></p>
</div>
