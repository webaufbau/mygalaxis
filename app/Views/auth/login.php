...
$platformColors = [
    'my_offertenheld_ch'     => ['primary' => '#667eea', 'secondary' => '#764ba2'],
    'my_offertenschweiz_ch'  => ['primary' => '#28a745', 'secondary' => '#1e7e34'],
    'my_renovo24_ch'         => ['primary' => '#17a2b8', 'secondary' => '#117a8b'],
];

$platform = str_replace(['.', '-'], '_', $_SERVER['HTTP_HOST'] ?? '');
...
$colors = $platformColors[$platform] ?? ['primary' => '#667eea', 'secondary' => '#764ba2'];
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(var(--primary-color-rgb, 102, 126, 234), 0.15);
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 20px rgba(var(--primary-color-rgb, 102, 126, 234), 0.3);
        }
    ...
    <div class="benefits-side">
        <div class="benefits-content">
            ...
            <div class="testimonial-card">
                <p class="testimonial-text"><?= lang('Auth.testimonialText') ?></p>
            </div>
            ...
            <div class="mt-4">
                <small class="opacity-75">
                    ...
                    <i class="bi bi-server"></i> <?= lang('Auth.swissServers') ?> •
